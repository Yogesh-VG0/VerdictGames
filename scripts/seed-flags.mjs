...
//
// Uses IGDB PopScore (popularity primitives) as PRIMARY
// source for REAL trending data, with RAWG fallback.
// Run: node scripts/seed-flags.mjs
// ═══════════════════════════════════════════════════════
